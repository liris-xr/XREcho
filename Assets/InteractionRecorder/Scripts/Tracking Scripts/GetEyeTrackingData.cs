...
//                    eyeObject = GameObject.Find("/Expe Recorder/Eye");
//                    recordingManager = RecordingManager.GetInstance();

//                    // maybe not useful but can get eye_parameter here
...
//                    eye_parameter.gaze_ray_parameter.sensitive_factor = 1;
...
//                    eyeObject.transform.position = Camera.main.transform.position;
//                    eyeObject.transform.LookAt(Camera.main.transform.position + GazeDirectionCombined);
//                }
